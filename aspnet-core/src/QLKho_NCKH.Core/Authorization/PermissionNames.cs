namespace QLKho_NCKH.Authorization
{
	public static class PermissionNames
	{
		...
		public const string Pages_StorageLocations = "Pages.StorageLocations";
		public const string Pages_StorageLocations_Create = "Pages.StorageLocations.Create";
		public const string Pages_StorageLocations_Edit = "Pages.StorageLocations.Edit";
		public const string Pages_StorageLocations_Delete = "Pages.StorageLocations.Delete";
