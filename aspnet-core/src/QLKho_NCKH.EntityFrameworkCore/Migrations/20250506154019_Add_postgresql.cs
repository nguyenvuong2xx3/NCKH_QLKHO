...
{
    /// <inheritdoc />
    public partial class Add_postgresql : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentVolume = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppStockTransactionDetails", x => new { x.StockTransactionId, x.ProductId, x.StorageLocationId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_AppStockTransactionDetails_AppStockTransactions_StockTransa~",
                        column: x => x.StockTransactionId,
                        principalTable: "AppStockTransactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppStockTransactionDetails_AppStorageLocations_StorageLocat~",
                        column: x => x.StorageLocationId,
                        principalTable: "AppStorageLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
